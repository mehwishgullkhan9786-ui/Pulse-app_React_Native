    ...
    <View style={styles.mainContainer}>
      ...
      <SafeAreaView style={styles.container}>
        ...
        >
          <View style={styles.header}>
            <View style={styles.headerLeft}>
              ...
              <Text style={styles.nameText}>Mehwish</Text>
            </View>
        ...
        <View style={styles.dashboardcontainer}>
          <View style={styles.dashboarddiv}>
            ...
            <View style={[styles.dashboarddivright, { backgroundColor: "rgba(0, 229, 255, 0.15)" }]}>
              <Text style={[styles.dashboarddivrightText, { color: "#00E5FF" }]}>
                {" "}
                <MaterialCommunityIcons name="arrow-up" size={15} color="#00E5FF" />
                12%
              </Text>
            </View>
          </View>
          ...
          <View style={styles.dashboarddiv}>
            <LinearGradient colors={["rgba(255,255,255,0.05)", "rgba(255,255,255,0)"]} style={StyleSheet.absoluteFillObject} />
            <View style={styles.dashboarddivleft}>
              <Text style={{ fontSize: 30, height: 35, marginTop: 15, marginBottom: 10 }}>💸</Text>
              <Text style={styles.dashboarddivleftText1}>$12K</Text>
              <Text style={styles.dashboarddivleftText2}>Revenue</Text>
            </View>
            <View style={[styles.dashboarddivright, { backgroundColor: "rgba(255, 45, 112, 0.15)" }]}>
              <Text style={[styles.dashboarddivrightText, { color: "#FF2D70" }]}>
                {" "}
                <MaterialCommunityIcons name="arrow-up" size={15} color="#FF2D70" />
                8%
              </Text>
            </View>
          </View>
          ...
          <View style={styles.dashboarddiv}>
            ...
            <View style={[styles.dashboarddivright, { backgroundColor: "rgba(255, 176, 0, 0.15)" }]}>
              <Text style={[styles.dashboarddivrightText, { color: "#FFB000" }]}>
                {" "}
                <MaterialCommunityIcons name="arrow-down" size={15} color="#FFB000" />
                3%
              </Text>
            </View>
          </View>
          ...
          <View style={styles.dashboarddiv}>
            <LinearGradient colors={["rgba(255,255,255,0.05)", "rgba(255,255,255,0)"]} style={StyleSheet.absoluteFillObject} />
            <View style={styles.dashboarddivleft}>
              <Text style={{ fontSize: 26, height: 35, marginTop: 15, marginBottom: 10 }}>⚡</Text>
              <Text style={styles.dashboarddivleftText1}>98%</Text>
              <Text style={styles.dashboarddivleftText2}>Uptime</Text>
            </View>
            <View style={[styles.dashboarddivright, { backgroundColor: "rgba(125, 95, 255, 0.15)" }]}>
              <Text style={[styles.dashboarddivrightText, { color: "#7D5FFF" }]}>
                {" "}
                <MaterialCommunityIcons name="arrow-up" size={15} color="#7D5FFF" />
                21%
              </Text>
            </View>
          </View>
        ...
        <View style={styles.traffic}>
          <Text style={styles.trafficText1}>
            {" "}
            <MaterialCommunityIcons name="chart-pie" size={16} color="#00E5FF" />
            {" "}TRAFFIC SOURCES
          </Text>
          <Text style={styles.trafficText2}>
            ALL{" "}
            <MaterialCommunityIcons name="arrow-right" size={16} color="#8A8D9F" />
          </Text>
        </View>
